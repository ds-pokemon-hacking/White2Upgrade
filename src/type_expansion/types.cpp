...
namespace w2u {
    extern "C" s32 THUMB_BRANCH_GetTypeEffectiveness(s32 t1, s32 t2) {
    ...
    extern "C" s32 THUMB_BRANCH_GetTypeWeaknesses(s32 t1, u8 *weakness_buffer) {
        u8 type_chart_buffer[0x144];
    ...
    extern "C" u32 THUMB_BRANCH_GetPokemonTypeIconPalette(u32 pokeType) {
